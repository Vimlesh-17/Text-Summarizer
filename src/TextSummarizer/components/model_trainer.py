...
from src.TextSummarizer.entity.__init__ import ModelTrainerConfig
...
class ModelTrainer:
    ...
    def train(self):
        ...
        model_pegaus = AutoModelForSeq2SeqLM.from_pretrained(self.config.model_ckpt).to(device)
        ...
        model_pegaus.save_pretrained(os.path.join(self.config.root_dir,"pegasus-samsum-model"))
